...
-- Query 5: Display all users and their booking IDs,including users who have never booked a ticket.
SELECT
    u.user_id,
    u.full_name,
    b.booking_id
...
-- Query 6: Find bookings whose total cost is greater than the average booking cost.
SELECT
    booking_id,
    match_id,
    total_cost
...
-- Query 7: Retrieve the top 2 most expensive matches,skipping the most expensive match.
SELECT
    match_id,
    fixture,
    base_ticket_price
